      ...
      <div className="container max-w-[1152px] mx-auto px-3">
        ...
        <div className="max-w-[970px] mx-auto  xl:pt-7">
          {accordianContent.map((value, index) => (
            <Accordion
              key={index}
              className="flex flex-col justify-between border-[0.5px] border-[#80898D] rounded-md px-6 bg-darkBlue overflow-hidden ease-out transition-all duration-300 mt-8 relative"
