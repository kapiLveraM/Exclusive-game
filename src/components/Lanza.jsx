...
const Lanza = () => {
  return (
    ...
    >
      ...
      <div className="container max-w-[1140px] mx-auto relative bg-[url('/assets/images/background/plataforma_bg_image.webp')] bg-no-repeat bg-size-full backdrop-blur-3xl bg-black  rounded-2xl border-[0.5px] border-[#b5ffb574]">
        {/* Content */}
