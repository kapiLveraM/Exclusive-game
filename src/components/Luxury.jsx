...
const Luxury = () => {
  return (
    <div className="container max-w-[1140px] mx-auto px-3 relative z-50">
     ...
     data-aos-duration="1000" className="bg-[url('/assets/images/background/Luxury.png')] py-[46px] bg-cover border-[0.5px] border-[#FFFFFF80] sm:border-none rounded-2xl sm:bg-[100%_100%] bg-no-repeat text-center flex justify-center flex-col items-center px-3 relative">
        <Image
          loading="lazy"
          width={78}
          height={79}
        ...
        <div className=" mt-9">
          <CommonButtonLiner type="subimt" content="Comprar ahora" />
        </div>
      </div>
    </div>
  );
